import PyPDF2
import re
import mysql.connector as konek
import os

db = konek.connect("127.0.0.1:4044","root","","pengemasan")
...
for berkas in berkasRegister:
	...
	for x,y in kamus.items():
		#print("INSERT INTO tb_register_spt VALUES (tgl_register,npwp,bps) VALUES ('",tgl_register,"','",x,"','",y,"')")
